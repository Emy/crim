...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            ...
            aliases: ['meme'],
            cooldown: 0,
            description: language => language.get('COMMAND_DANKMEME_DESCRIPTION'),
        });
    }

    async run(message, [...params]) {
        try {
            let data = await fetch(`https://www.reddit.com/user/emdix/m/dankmemes/top/.json?sort=top&t=day&limit=500`);
